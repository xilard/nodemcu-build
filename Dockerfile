...
RUN apt-get update && \
	...
	pip install --user --upgrade pip pyserial future cryptography "pyparsing>=2.0.3,<2.4.0" click pyelftools "python-socketio<5" "gdbgui==0.13.2.0" "pygdbmi<=0.9.0.2" "reedsolo>=1.5.3,<=1.5.4" bitstring ecdsa
